...
#SYSTEM_ID = "sys47c67" #1
#SYSTEM_ID = "sys91caa" #2
#SYSTEM_ID = "sys83aed" #3 
#SYSTEM_ID = "sys78aec" #4
SYSTEM_ID = "sys753b8" #5
...
def run():
    ...
    # concat: seconds, pred_concat, target_concat
    ...
    # running mean: elapsed, pred_rm, target_rm
